...
func NewHandler(svc *Service, platformKey string) *Handler {
    return &Handler{svc: svc, platformKey: platformKey}
}
...
func (h *Handler) CreateTenant(w http.ResponseWriter, r *http.Request) {
    ...
    resp, err := h.svc.CreateTenant(r.Context(), req, providedKey, h.platformKey)
    if err != nil {
